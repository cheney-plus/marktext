  ...
  <div class="print-settings-dialog">
    ...
    >
      ...
      <el-tabs v-model="activeName">
        <el-tab-pane :label="$t('Info')" name="info">
          <span class="text">{{ $t('Please customize the page appearance and click on "export" to continue.') }}</span>
        </el-tab-pane>
        <el-tab-pane :label="$t('Page')" name="page">
          <!-- HTML -->
          ...
          <div v-if="isPrintable">
            <div v-if="exportType === 'pdf'">
              ...
              <bool
                :description="$t('Landscape orientation:')"
                :bool="isLandscape"
            ...
            <div class="row">
              <div class="description">{{ $t('Page margin in mm:') }}</div>
              <div>
                <div class="label">{{ $t('Top/Bottom:') }}</div>
              ...
              <div>
                <div class="label">{{ $t('Left/Right:') }}</div>
        ...
        <el-tab-pane :label="$t('Style')" name="style">
          <bool
            :description="$t('Overwrite theme font settings:')"
        ...
        <el-tab-pane v-if="isPrintable" :label="$t('Header & Footer')" name="header">
          <div class="text">{{ $t('The text appear on all pages if header and/or footer is defined.') }}</div>
          <cur-select
            :description="$t('Header type:')"
            :value="headerType"
          ...
          <text-box
            v-if="headerType === 2"
            :description="$t('The left header text:')"
          ...
          <text-box
            v-if="headerType !== 0"
            :description="$t('The main header text:')"
          ...
          <text-box
            v-if="headerType === 2"
            :description="$t('The right header text:')"
          ...
          <text-box
            v-if="footerType === 2"
            :description="$t('The left footer text:')"
          ...
          <text-box
            v-if="footerType !== 0"
            :description="$t('The main footer text:')"
          ...
          <text-box
            v-if="footerType === 2"
            :description="$t('The right footer text:')"
          ...
          <div v-if="headerFooterCustomize">
            <bool
              :description="$t('Allow styled header and footer:')"
              :bool="headerFooterStyled"
              :onChange="value => onSelectChange('headerFooterStyled', value)"
            ></bool>
            <range
              :description="$t('Header and footer font size')"
        ...
        <el-tab-pane :label="$t('Table of Contents')" name="toc">
          <bool
            :description="$t('Include top heading:')"
            :detailedDescription="$t('Includes the first heading level too.')"
...
export default {
  ...
  data () {
    ...
    this.pageSizeList = getPageSizeList(this.$t)
    this.headerFooterTypes = getHeaderFooterTypes(this.$t)
    this.headerFooterStyles = getHeaderFooterStyles(this.$t)
    return {
      isPrintable: true,
      ...
      theme: 'default',
      themeList: getExportThemeList(this.$t),
      headerType: 0,
      headerTextLeft: '',
      headerTextCenter: '',
      headerTextRight: '',
